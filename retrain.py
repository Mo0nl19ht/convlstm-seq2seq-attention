...
model.load_weights("seq2seq_디코더까지layernorm_inside_64_1e-05_mse_4_12000+1000_0.1.h5")
optimizer = tf.keras.optimizers.Adam(lr)

ckpt,ckpt_manager = make_checkpoint(checkpoint_path,model,optimizer)

file_name=f'seq2seq_디코더까지layernorm_inside_{filter_size}_{lr}_{loss_f}_{num_layer}_13000+{epochs}_{drop}'
print(file_name)
